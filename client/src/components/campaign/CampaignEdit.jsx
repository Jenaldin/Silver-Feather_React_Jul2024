...
export default function CampaignEdit() {
   const { handleSubmit, register, formState: { errors }, setValue, watch, trigger } = useForm();
            ...
            setCampaignDetails({ ...campaignDetails, title: e.target.value });
                        ...
                        <Grid item xs={12} md={6}>
                           <FormControl fullWidth error={!!errors.setting}>
                              <InputLabel id="setting-label" shrink={!!watch('setting') || !!campaignDetails.setting} >Campaign Setting *</InputLabel>
                              <Select
                                 {...register('setting', {
